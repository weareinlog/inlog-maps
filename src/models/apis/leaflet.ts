...
export default class Leaflet implements IMapFunctions {
    private leafletMarkers: LeafletMarkers | null = null;
    private leafletPolygons: LeafletPolygons | null = null;
    private leafletCircles: LeafletCircles | null = null;
    private leafletPolylines: LeafletPolylines | null = null;
    private leafletPopups: LeafletPopups | null = null;
    ...
    public async initialize(
        ...
        try {
            ...
            const osm = new leaflet.tileLayer(
                "https://tile.openstreetmap.org/{z}/{x}/{y}.png",
                mapOptions
            );
            const wikimedia = new leaflet.tileLayer(
    ...
    public alterMarkerPosition(
        ...
        this.leafletMarkers?.alterMarkerPosition(
            markers,
            position,
            addTransition
        );
    ...
    public addPolygonEvent(
        ...
        this.leafletPolygons?.addPolygonEvent(
            polygons,
            eventType,
            eventFunction
        );
    ...
    public addPolylineEvent(
        ...
        this.leafletPolylines?.addPolylineEvent(
            polylines,
            eventType,
            eventFunction
        );
    ...
    public addPolylineHighlightEvent(
        ...
        this.leafletPolylines?.addPolylineHighlightEvent(
            eventType,
            eventFunction
        );
    }
    ...
    public checkIdx(
        ...
        const result = this.leafletPolylines?.checkIdx(polyline, {
            lat: point[0],
            lng: point[1],
        });
        return result;
    ...
    public async takeMapScreenshot(): Promise<string | null> {
        const image = await this.leafletScreenshot.takeScreen("image");
        return image;
    }
    ...
    public fitBoundsElements(
        ...
        this.leafletMap?.fitBoundsElements(
            markers,
            circles,
            polygons,
            polylines
